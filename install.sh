...
tar xvfp void-aarch64-ROOTFS-20250202.tar.xz -C /mnt #install system
tar -xf void-rpi-aarch64-PLATFORMFS-20250202.tar.xz --strip-components=1 -C /mnt ./boot #Install boot firmware
...
xchroot /mnt xbps-install -Suvy cryptsetup lvm2 linux linux-headers dracut
...
#Generate initramfs
xchroot /mnt dracut -f /boot/initramfs.img --kver $(uname -r)
=======
...
>>>>>>> parent of 400eb91 (Dracut keeps generating for rpi kernel no matter what)
